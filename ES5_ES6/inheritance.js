...
const bug3 = new Bug("Buggy", "Your debugger doesn't work with me!", 10)
const Robot3 = new Robot("Tito", "I can cook, swim and dance!", 15)

console.log(bug3.power) //output: 10
Robot3.attack() // output: "I'm attacking with a power of 15!"
...
const alien4 = new Alien("Lien", "Run for your lives!", 15, 60)
